      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Restoring Sight, Restoring Hope</h2>
            <p className="text-lg text-gray-600 mb-8">
              Every year, we sponsor 12+ cataract surgeries, restoring sight and hope to those who cannot afford it. We
              also provide free prescription eyewear to underprivileged children, senior citizens, and residents of
              orphanages and old-age homes—empowering them to see the world clearly and live fully.
            </p>
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-semibold mb-2">Refurbish</h4>
                  <p className="text-gray-600">We'll refurbish and distribute them to those in need</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-primary text-white rounded-full flex items-center justify-center font-bold text-xl mx-auto mb-4">
